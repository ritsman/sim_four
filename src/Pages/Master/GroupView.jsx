      ...
      <Grid verticalAlign="middle">
        ...
        <GridRow centered>
          ...
          >
            <TableBody>
              <TableRow>
                <TableCell style={{ fontWeight: "900" }}>Group Name</TableCell>
                <TableCell>{group.group_name}</TableCell>
                <TableCell style={{ fontWeight: "900" }}>Group Type</TableCell>
                <TableCell>{group.group_type}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell style={{ fontWeight: "900" }}>Group Items</TableCell>
                <TableCell>{group.group_tems.split("**").join(", ")}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </GridRow>
